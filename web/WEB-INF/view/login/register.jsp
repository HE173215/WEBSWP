...
<!--sua code-->
                                ...
                                <div class="form-floating mb-3">
                                    <input type="tel" name="mobile" class="form-control" id="floatingPhone" placeholder="Your Phone">
                                ...
                                <div class="form-floating mb-4">
                                    <input type="password" name="confirmPass" class="form-control" id="floatingRePassword" placeholder="Re-type Password">
                                    <label for="floatingRePassword">Re-type Password</label>
                                </div>
